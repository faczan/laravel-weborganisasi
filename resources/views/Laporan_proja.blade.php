...
<div class="content mt-3">
    ...
    <div class="animated fadeIn">
        <h1>Program Kerja Organisasi</h1>
         <br>
    </div>
    ...
    <form>
        ...
        <div class="row mb-2">
            <label for="inputNAMA" class="col-sm-2 col-form-label">Nama Program Kerja</label>
            <div class="col-sm-9">
              <input type="Nama" class="form-control" id="inputEmail3">
            </div>
        </div>
        <div class="row mb-2">
            <label for="inputNAMA" class="col-sm-2 col-form-label">Tanggal Program Kerja</label>
            <div class="col-sm-9">
                <div class="row g-3">
                    <div class="col-sm">
      ...
      <div class="row mb-2">
        <label for="inputNAMA" class="col-sm-2 col-form-label">File Laporan</label>
        <div class="col-sm-9">
