        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="/program"> <i class="menu-icon fa fa-dashboard"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="/anggota"> <i class="menu-icon fa fa-puzzle-piece"></i>manajemen profil </a>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/data_laporan">Program Kerja</a></li>
                            <li><i class="fa fa-table"></i><a href="/Kegiatan">Laporan Kegiatan</a></li>
                            <li><i class="fa fa-table"></i><a href="/Proposal">Proposal Kegiatan</a></li>
                        </ul>
                    </li>
