...
<head>
    ...
    <title>@yield('title') - Organiztion Report</title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='style/text/css'>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">ORGANIZATION REPORT
                </a>
                <a class="navbar-brand hidden" href="">OR
                </a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="/dasboard"> <i class="menu-icon fa fa-dashboard"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="/about"> <i class="menu-icon fa fa-puzzle-piece"></i>Profil User </a>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/Laporan_proja">Program Kerja</a></li>
                            <li><i class="fa fa-table"></i><a href="/Laporan_Kegiatan">Laporan Kegiatan</a></li>
                            <li><i class="fa fa-table"></i><a href="/Proposal_Kegiatan">Proposal Kegiatan</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
